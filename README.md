...
A RESTful API for tracking exercises, workout plans, and logged sessions, with analytical endpoints for progress tracking, personal records, and training volume trends.
...
- **User authentication** — JWT-based register/login flow
